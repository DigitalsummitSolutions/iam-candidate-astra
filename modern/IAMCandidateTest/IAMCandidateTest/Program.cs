...
var connectionString = builder.Configuration.GetConnectionString("IAmCandidateTestConnection"); ;

builder.Services.AddDbContext<IAMCandidateTestDbContext>(options =>
